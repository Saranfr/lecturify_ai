  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-primary-900 to-slate-900">
      <div className="card w-full max-w-md shadow-xl">
        ...
        <h1 className="text-2xl font-bold text-center mb-6">Lecturify AI</h1>
        ...
        <div className="mt-8 p-4 rounded-xl bg-slate-50 border border-slate-200 text-left">
          <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-2">Demo logins</p>
          <ul className="text-xs text-slate-600 space-y-2 font-mono">
            <li><span className="text-slate-400">Instructor:</span> instructor@lecturify.demo / Lect2026!</li>
            <li><span className="text-slate-400">Student:</span> student@lecturify.demo / Stud2026!</li>
            <li><span className="text-slate-400">Admin:</span> admin@lecturify.demo / Admin2026!</li>
          </ul>
        </div>
      </div>
    </div>
